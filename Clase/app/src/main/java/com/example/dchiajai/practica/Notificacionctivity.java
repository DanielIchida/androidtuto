...
public class Notificacionctivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notificacionctivity);
    ...
    public void updateNotification() {
        ...
        Bitmap androidImage = BitmapFactory
                .decodeResource(getResources(), R.drawable.ic_cafe);
